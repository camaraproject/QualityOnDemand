...
| | [QoD API Spec v0.8.0](https://github.com/camaraproject/QualityOnDemand/blob/r4.1/code/API_definitions/qod-api.yaml) merged. See [#42](https://github.com/camaraproject/QualityOnDemand/issues/42) for a summary of changes.<br>Documentation and reference implementation to be updated -> new issues. |
