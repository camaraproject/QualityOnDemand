...
|  6 | User stories                                 |   O   |         O         |    O    |    M   | ?    | /documentation/API_documentation/QoD_User_Story.md |
|  7 | Basic API test cases & documentation         |   O   |         M         |    M    |    M   | tbd  | /code/Test_definitions/QoD_API_Test.feature |
