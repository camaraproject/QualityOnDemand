Feature: CAMARA QoS Provisioning API, 0.4.0-alpha.1 - Operation getQosAssignmentByDevice
  ...
  Background: Common getQosAssignmentByDevice setup
    ...
    And the resource "/qos-provisioning/v0.4alpha1/retrieve-qos-assignment"
