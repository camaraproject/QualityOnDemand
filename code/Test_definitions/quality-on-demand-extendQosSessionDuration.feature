Feature: CAMARA Quality On Demand API, 1.2.0-alpha.1 - Operation extendQosSessionDuration
  ...
  Background: Common extendQosSessionDuration setup
    ...
    And the resource "/quality-on-demand/v1alpha1/sessions/{sessionId}/extend"
