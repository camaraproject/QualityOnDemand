Feature: CAMARA QoS Provisioning API, 0.4.0-alpha.1 - Operation getQosAssignmentById
  ...
  Background: Common getQosAssignmentById setup
    ...
    And the resource "/qos-provisioning/v0.4alpha1/qos-assignments/{assignmentId}"
